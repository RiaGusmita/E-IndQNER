...
chapter_list = ["059-Al_Hasyr.txt", "058-Al_Mujadalah.txt", "057-Al_Hadid.txt", "056-Al_Waqi'ah.txt", "055-Ar_Rahman.txt", "054-Al_Qamar.txt", "053-An_Najm.txt", "052-At_Tur.txt", "051-Az_Zariyat.txt", "050-Qaf.txt"]
